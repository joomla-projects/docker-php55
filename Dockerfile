...
# Install
RUN apt-get update \
	&& DEBIAN_FRONTEND='noninteractive' apt-get install -y php5 php5-cli php5-memcache php5-memcached php5-redis php5-xdebug wget \
		git curl php5-gd php5-mcrypt php5-mysql php5-sqlite \
